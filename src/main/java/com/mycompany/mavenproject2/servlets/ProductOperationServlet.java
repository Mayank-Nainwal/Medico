...
import com.mycompany.mavenproject2.dao.CategoryDao;
import com.mycompany.mavenproject2.dao.ProductDao;
import com.mycompany.mavenproject2.entities.Category;
import com.mycompany.mavenproject2.entities.Product;
import java.io.File;
...
//                
                ...
                HttpSession httpSession = request.getSession();
                httpSession.setAttribute("message","Medicine Added Sucessfully");
                response.sendRedirect("admin.jsp");
                return;
            }
